...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/sys/dev/loadAppInfoList">
			...
			<div class="x_content">
				...
				<div id="datatable-responsive_wrapper"
					...
					<div class="row">
						<div class="col-sm-12">
							<a
								href="${pageContext.request.contextPath}/sys/dev/add"
							...
							<table id="datatable-responsive"
								...
								<tbody>
									<c:forEach var="appInfo" items="${list }"
										varStatus="status">
										<tr role="row" class="odd">
											...
											<td>${appInfo.cateGoryLevelName1 }->
												${appInfo.cateGoryLevelName2 } ->
												${appInfo.cateGoryLevelName3 }</td>
					...
					<div class="row">
						<div class="col-sm-5">
							<div class="dataTables_info" id="datatable-responsive_info"
								role="status" aria-live="polite">共${pages.infoCount }条记录
								${pages.currPageNo }/${pages.pageCount }页</div>
						</div>
						<div class="col-sm-7">
							<div class="dataTables_paginate paging_simple_numbers"
								...
								<ul class="pagination">
									...
									<c:if test="${pages.currPageNo < pages.pageCount }">
										<li class="paginate_button "><a
											href="javascript:page_nav(document.forms[0],${pages.currPageNo+1 });"
											aria-controls="datatable-responsive" data-dt-idx="1"
											tabindex="0">下一页</a></li>
